...
@Component({
  ...
  `,
  styles: `
    :host { display: block; flex: none; --gn-card-bar: 44px; }
    .card {
      display: flex; flex-direction: column; gap: 8px; overflow: hidden;
      padding: 0; border-radius: var(--gn-radius); background: var(--color-surface);
    }
    .card--boosted { box-shadow: var(--gn-shadow-boost); }

    .meta {
      display: flex; align-items: center; gap: 6px; box-sizing: border-box; height: var(--gn-card-bar); padding: 0 14px; font-size: 12px;
      background: var(--color-bg); /* Kopfzeile in Seitenfarbe, Koerper und Fussleiste auf der Kartenflaeche */
    }
    ...
    .kicker { font-size: 10px; text-transform: uppercase; letter-spacing: .1em; color: var(--color-cat); white-space: nowrap; }
    ...
    .stickers { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; min-width: 0; margin-left: 8px; }
    .tile {
    ...
    .actions {
      display: flex; align-items: center; gap: 4px; box-sizing: border-box; height: var(--gn-card-bar); margin-top: 6px; padding: 0 8px 0 14px;
